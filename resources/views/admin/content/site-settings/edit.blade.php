...
<div class="grid md:grid-cols-2 gap-3">
    <div>
        <input type="file" name="logo" class="border rounded px-3 py-2 w-full">
        <img src="{{ \App\Support\Media\MediaManager::url($setting->logo, 'images/placeholders/avatar.svg') }}" class="mt-2 h-14 w-14 rounded-full object-cover border" alt="Logo preview">
    </div>
    <div>
        <input type="file" name="favicon" class="border rounded px-3 py-2 w-full">
        <img src="{{ \App\Support\Media\MediaManager::url($setting->favicon, 'images/placeholders/avatar.svg') }}" class="mt-2 h-10 w-10 rounded object-cover border" alt="Favicon preview">
    </div>
</div>
