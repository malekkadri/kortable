...
<img src="{{ \App\Support\Media\MediaManager::url($testimonial->avatar, 'images/placeholders/avatar.svg') }}" alt="Avatar preview" class="h-14 w-14 rounded-full object-cover border">
